 ...
 * 例: npm run create:pkg sass/test 在sass目录下创建test目录，项目名默认test
 * 例: npm run create:pkg sass/test -p vue-project -t vue 在saas目录下创建test目录，项目名为vue-project，模板为vue
 */
...
const templatePoints = {
  dirName, // 项目所在文件夹名
  dirPath, // 项目相对路径
  projectBaseName, // 项目基本名称。例如：@neuton/my-project，my-project就是基本名称
  projectName, // 项目名
